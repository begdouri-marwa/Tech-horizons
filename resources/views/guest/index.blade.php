...
@section('title', 'Home - Browse Articles')
...
@section('content')
    ...
    <div class="dashboard-container">
        <h1>Welcome, Guest</h1>
        <p>Browse issues and their public articles.</p>
        <br />
        ...
        @forelse($issues as $issue)
            <div class="issue-card">
                <div class="issue-header">
                    ...
                    <p class="issue-publish-date">Published on: {{ $issue->published_at->format('M d, Y') }}</p>
                </div>
        ...
        @empty
            <p>No published issues available.</p>
        @endforelse
    </div>
@endsection
